...
class StoreMenuViewBackup extends StatefulWidget {
  final StoreList storeList;

  StoreMenuViewBackup(this.storeList);

  @override
  _StoreMenuViewBackupState createState() =>
      _StoreMenuViewBackupState(storeList);
}

class _StoreMenuViewBackupState extends State<StoreMenuViewBackup>
  ...
  _StoreMenuViewBackupState(this._storeList);
        ...
        builder: (context, viewModel, child) {
          ...
          return Scaffold(
            ...
            body: NestedScrollView(
                ...
                return [
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background:
                          _getStoreDetails(context, screenHeight, screenWidth),
              ...
              body: viewModel.getStoreMenu == null
                  ? Container()
                  : TabBarView(
  ...
  _getProductListItem(context, index, StoreItem storeItem) {
    String? variants;
    ...
    return Container(
      margin: EdgeInsets.only(left: 20, right: 20, top: index == 0 ? 0 : 22),
      child: Column(
